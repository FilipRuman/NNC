...
```bash
nix-shell -p wget git --run 'wget -O /tmp/NNCinstall.sh https://raw.githubusercontent.com/FilipRuman/NNC/refs/heads/main/installation/install.sh; sudo chmod +x /tmp/NNCinstall.sh; sudo -sE bash /tmp/NNCinstall.sh'
```
